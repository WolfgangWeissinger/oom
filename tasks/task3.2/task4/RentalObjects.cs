...
class calculation_regular_customer : calculation
{
    public override double price_calculation_pickup(double price, int days)
    {
        return (price * days) * 0.9;
    }
    public override double price_calculation_delievery(double price, int days)
    {
        return (price * days) * 0.9 + 25;
    }
}

class calculation_new_customer : calculation
{
    public override double price_calculation_pickup(double price, int days)
    {
        return (price * days);
...
class RentalObjects
    {
        ...
        // Methods
        public double price_calculation (double price, int days)
        {
        ...
        // Constructor
        public RentalObjects (string newname, double newprice_weekdays, double newprice_weekends, double newprice_48h, int newweight)
        {
